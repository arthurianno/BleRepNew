...
public final class FragmentLogBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView logRecView;

  private FragmentLogBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView logRecView) {
    this.rootView = rootView;
    this.logRecView = logRecView;
  }
  ...
  public static FragmentLogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logRecView;
      RecyclerView logRecView = ViewBindings.findChildViewById(rootView, id);
      if (logRecView == null) {
        break missingId;
      }

      return new FragmentLogBinding((ConstraintLayout) rootView, logRecView);
    }
