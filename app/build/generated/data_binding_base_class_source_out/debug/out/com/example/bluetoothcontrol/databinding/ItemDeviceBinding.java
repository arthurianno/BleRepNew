...
public final class ItemDeviceBinding implements ViewBinding {
  ...
  private ItemDeviceBinding(@NonNull LinearLayout rootView, @NonNull TextView textAddress,
  ...
  public static ItemDeviceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDeviceBinding((LinearLayout) rootView, textAddress, textName);
    }
